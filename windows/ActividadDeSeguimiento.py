...
class ActividadDeSeguimientoScreen(Screen):
    project = None
    operator = None
    payeeDocument = None
    home = False
...
class Estado_de_metas_seguimiento(class_declaration.PopupFather):
    ...
    def accionAceptar(self, *args):
        ...
        if False in dili:
            ActividadDeSeguimientoScreen.metas_terminadas = False
        else:
            ActividadDeSeguimientoScreen.estados_metas = answ
            ActividadDeSeguimientoScreen.metas_terminadas = True
            self.dismiss()
